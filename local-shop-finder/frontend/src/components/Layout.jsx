...
const navLinkClass = ({ isActive }) =>
  [
    ...
    isActive ? 'bg-rose-600 text-white shadow-lg shadow-rose-600/25' : 'text-slate-600 hover:bg-slate-100',
  ].join(' ');

function Layout() {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#fff7ed_0,_#fff1f2_35%,_#f8fafc_72%)] text-slate-900">
